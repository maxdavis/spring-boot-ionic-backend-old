...
public class DBService {
	...
	public void instantiateTestDataBase() throws ParseException {
		...
		Produto p7 = new Produto(null, "Tv Smart 50", 2500.00);
		...
		Cliente cli2 = new Cliente(null, "Ana Costa", "onfaces@gmail.com", "61473517885", TipoCliente.PESSOAFISICA, bCryptPassword.encode("123"));
		...
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, ped2, sdf.parse("01/11/2017 07:09"),
				null);
		...
		p3.getItens().addAll(Arrays.asList(item1));
